const inputs = {
    designType: document.querySelector("input[name=graphic-type]"),
    suggestedTime: document.querySelector("input[name=suggested-time]"),
...
function Submit(event) {
    ...
    const data = {
        designType: inputs.designType.value,
        suggestedTime: inputs.suggestedTime.value,
    ...
    xhr.open("POST", "../../../assets/php/ajax/services/graphic-design.php");
