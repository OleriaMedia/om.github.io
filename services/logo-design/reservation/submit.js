const inputs = {
    logoType: document.querySelector("input[name=logo-type]"),
    deliveryTime: document.querySelector("input[name=delivery-time]"),
...
function Submit(event) {
    ...
    const data = {
        ...
        deliveryTime: inputs.deliveryTime.value,
    ...
    xhr.open("POST", "../../../assets/php/ajax/services/logo-design.php");
